...
public class Product {
	  ...
	  // Static and instance variables 
	   ...
	   // Static method to update the discount percentage and  Method to calculate the price after applying the discount
	   ...
	   public static void main(String[] args) {
	       // Update the discount for all products, create new product instances and display product details
